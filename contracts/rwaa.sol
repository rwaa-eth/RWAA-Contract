...
contract RWAAV1 is ERC721, ERC721Enumerable, Ownable, ERC5169 {
    ...
    returns (string memory)
    {
        ...
        if (!tokenId2TokenInfo[tokenId].isParent) {
            url = "https://storage.googleapis.com/opensea-prod.appspot.com/puffs/4.png";
        }
